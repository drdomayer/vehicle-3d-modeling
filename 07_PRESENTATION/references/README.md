# Reference renders (AI-generated, ChatGPT)

| File | What | Status |
|---|---|---|
| ref-01-e46-supercar-concept-REJECTED-donor.png | First STATEV 001 infographic on a claimed BMW E46 base. Mid-engine Huracán-type silhouette — impossible on E46. Kept for design language (front mask, light blade, panel breakdown, interior direction) | donor REJECTED, look = inspiration only |
