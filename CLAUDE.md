...
- Next: **решение по прага** (`docs/14` раздел D — 47° при G1 лента 8–40; или лентата е твърде
  тясна, или преходът се връща на ~18 mm). После **дванайсетте неизмерими прехода** от `CONTINUITY`:
  нито един не е дефект, но и нито един не е проверен, защото за него не съществува таблица с
  височина — това е следващата истинска работа по характера, и тя е дефиниране на линии, не
  настройка на числа. И **етап 02 — реални повърхности по зони**, patch-базирани по `docs/16`,
  при спазена карта на непрекъснатостта 5×G0 / 10×G1 / 2×G2. Това е единственото, което стои между регистъра от 38
